...
public class PetriImpl extends MinimalEObjectImpl.Container implements Petri {
	...
	public EList<PetriElement> getPetriElements() {
		if (petriElements == null) {
			petriElements = new EObjectContainmentWithInverseEList<PetriElement>(PetriElement.class, this, PetrinetPackage.PETRI__PETRI_ELEMENTS, PetrinetPackage.PETRI_ELEMENT__NET);
		}
