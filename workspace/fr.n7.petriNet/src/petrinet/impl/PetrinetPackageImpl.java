...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 * @generated
	 */
	public EReference getPetriElement_Net() {
	 ...
	 * @generated
	 */
	public EAttribute getPlace_NbTokens() {
	...
	public void createPackageContents() {
		...
		createEReference(petriElementEClass, PETRI_ELEMENT__NET);
	...
	public void initializePackageContents() {
		...
		initEReference(getPetri_PetriElements(), this.getPetriElement(), this.getPetriElement_Net(), "petriElements", null, 0, -1, Petri.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		initEClass(petriElementEClass, PetriElement.class, "PetriElement", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
		initEReference(getPetriElement_Net(), this.getPetri(), this.getPetri_PetriElements(), "net", null, 1, 1, PetriElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		addEEnumLiteral(arcTypeEEnum, ArcType.NORMAL_ARC);
