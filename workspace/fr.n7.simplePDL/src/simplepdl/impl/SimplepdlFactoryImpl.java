...
public class SimplepdlFactoryImpl extends EFactoryImpl implements SimplepdlFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			...
			case SimplepdlPackage.USEFUL_RESSOURCE: return createUsefulRessource();
			default:
	 ...
	 * @generated
	 */
	public UsefulRessource createUsefulRessource() {
		UsefulRessourceImpl usefulRessource = new UsefulRessourceImpl();
		return usefulRessource;
	}
