 ...
 *   <li>{@link simplepdl.impl.WorkDefinitionImpl#getUsefulRessources <em>Useful Ressources</em>}</li>
 * </ul>
 *
 * @generated
 */
public class WorkDefinitionImpl extends ProcessElementImpl implements WorkDefinition {
	...
	/**
	 * The cached value of the '{@link #getUsefulRessources() <em>Useful Ressources</em>}' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see #getUsefulRessources()
	 * @generated
	 * @ordered
	 */
	protected EList<UsefulRessource> usefulRessources;
	 ...
	 * @generated
	 */
	public EList<UsefulRessource> getUsefulRessources() {
		if (usefulRessources == null) {
			usefulRessources = new EObjectContainmentWithInverseEList<UsefulRessource>(UsefulRessource.class, this, SimplepdlPackage.WORK_DEFINITION__USEFUL_RESSOURCES, SimplepdlPackage.USEFUL_RESSOURCE__ASSOCIATED_WORK_DEFINITION);
		}
		return usefulRessources;
	}
	...
	public NotificationChain eInverseAdd(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USEFUL_RESSOURCES:
				return ((InternalEList<InternalEObject>)(InternalEList<?>)getUsefulRessources()).basicAdd(otherEnd, msgs);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USEFUL_RESSOURCES:
				return ((InternalEList<?>)getUsefulRessources()).basicRemove(otherEnd, msgs);
		}
	...
	public void eSet(int featureID, Object newValue) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__NAME:
				...
				return;
			case SimplepdlPackage.WORK_DEFINITION__USEFUL_RESSOURCES:
				getUsefulRessources().clear();
				getUsefulRessources().addAll((Collection<? extends UsefulRessource>)newValue);
				return;
		}
	...
	public boolean eIsSet(int featureID) {
		switch (featureID) {
			...
			case SimplepdlPackage.WORK_DEFINITION__USEFUL_RESSOURCES:
				return usefulRessources != null && !usefulRessources.isEmpty();
		}
