...
public interface SimplepdlPackage extends EPackage {
	...
	/**
	 * The feature id for the '<em><b>Useful Ressources</b></em>' containment reference list.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int WORK_DEFINITION__USEFUL_RESSOURCES = PROCESS_ELEMENT_FEATURE_COUNT + 3;
	...
	/**
	 * The meta object id for the '{@link simplepdl.impl.UsefulRessourceImpl <em>Useful Ressource</em>}' class.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @see simplepdl.impl.UsefulRessourceImpl
	 * @see simplepdl.impl.SimplepdlPackageImpl#getUsefulRessource()
	 * @generated
	 */
	int USEFUL_RESSOURCE = 6;

	/**
	 * The feature id for the '<em><b>Useful Quantity</b></em>' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 * @ordered
	 */
	int USEFUL_RESSOURCE__USEFUL_QUANTITY = 0;
	 ...
	 * @ordered
	 */
	int USEFUL_RESSOURCE_OPERATION_COUNT = 0;
	...
	/**
	 * Returns the meta object for the containment reference list '{@link simplepdl.WorkDefinition#getUsefulRessources <em>Useful Ressources</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the containment reference list '<em>Useful Ressources</em>'.
	 * @see simplepdl.WorkDefinition#getUsefulRessources()
	 * @see #getWorkDefinition()
	 * @generated
	 */
	EReference getWorkDefinition_UsefulRessources();
	...
	/**
	 * Returns the meta object for class '{@link simplepdl.UsefulRessource <em>Useful Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for class '<em>Useful Ressource</em>'.
	 * @see simplepdl.UsefulRessource
	 * @generated
	 */
	EClass getUsefulRessource();

	/**
	 * Returns the meta object for the attribute '{@link simplepdl.UsefulRessource#getUsefulQuantity <em>Useful Quantity</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the attribute '<em>Useful Quantity</em>'.
	 * @see simplepdl.UsefulRessource#getUsefulQuantity()
	 * @see #getUsefulRessource()
	 * @generated
	 */
	EAttribute getUsefulRessource_UsefulQuantity();

	/**
	 * Returns the meta object for the reference '{@link simplepdl.UsefulRessource#getRessource <em>Ressource</em>}'.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @return the meta object for the reference '<em>Ressource</em>'.
	 * @see simplepdl.UsefulRessource#getRessource()
	 * @see #getUsefulRessource()
	 * @generated
	 */
	...
	interface Literals {
		...
		/**
		 * The meta object literal for the '<em><b>Useful Ressources</b></em>' containment reference list feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EReference WORK_DEFINITION__USEFUL_RESSOURCES = eINSTANCE.getWorkDefinition_UsefulRessources();
		...
		/**
		 * The meta object literal for the '{@link simplepdl.impl.UsefulRessourceImpl <em>Useful Ressource</em>}' class.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @see simplepdl.impl.UsefulRessourceImpl
		 * @see simplepdl.impl.SimplepdlPackageImpl#getUsefulRessource()
		 * @generated
		 */
		EClass USEFUL_RESSOURCE = eINSTANCE.getUsefulRessource();

		/**
		 * The meta object literal for the '<em><b>Useful Quantity</b></em>' attribute feature.
		 * <!-- begin-user-doc -->
		 * <!-- end-user-doc -->
		 * @generated
		 */
		EAttribute USEFUL_RESSOURCE__USEFUL_QUANTITY = eINSTANCE.getUsefulRessource_UsefulQuantity();
