...
public class PlaceItemProvider extends NodeItemProvider {
	...
	public List<IItemPropertyDescriptor> getPropertyDescriptors(Object object) {
		if (itemPropertyDescriptors == null) {
			...
			addNbTokensPropertyDescriptor(object);
		}
		return itemPropertyDescriptors;
	}

	/**
	 * This adds a property descriptor for the Nb Tokens feature.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
	 * @generated
	 */
	protected void addNbTokensPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Place_nbTokens_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Place_nbTokens_feature", "_UI_Place_type"),
				 PetrinetPackage.Literals.PLACE__NB_TOKENS,
				 true,
				 false,
				 false,
