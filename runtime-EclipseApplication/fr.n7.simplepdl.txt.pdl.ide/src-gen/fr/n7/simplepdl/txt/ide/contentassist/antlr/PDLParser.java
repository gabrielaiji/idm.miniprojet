...
public class PDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getUsefulRessourceAccess().getGroup(), "rule__UsefulRessource__Group__0");
			...
			builder.put(grammarAccess.getWorkDefinitionAccess().getUsefulRessourcesAssignment_6_2(), "rule__WorkDefinition__UsefulRessourcesAssignment_6_2");
			builder.put(grammarAccess.getWorkDefinitionAccess().getUsefulRessourcesAssignment_6_3_1(), "rule__WorkDefinition__UsefulRessourcesAssignment_6_3_1");
			...
			builder.put(grammarAccess.getGuidanceAccess().getTextAssignment_3_1(), "rule__Guidance__TextAssignment_3_1");
			...
			builder.put(grammarAccess.getRessourceAccess().getQuantityAssignment_4(), "rule__Ressource__QuantityAssignment_4");
			builder.put(grammarAccess.getUsefulRessourceAccess().getUsefulQuantityAssignment_3(), "rule__UsefulRessource__UsefulQuantityAssignment_3");
			builder.put(grammarAccess.getUsefulRessourceAccess().getRessourceAssignment_5(), "rule__UsefulRessource__RessourceAssignment_5");
		}
	}
