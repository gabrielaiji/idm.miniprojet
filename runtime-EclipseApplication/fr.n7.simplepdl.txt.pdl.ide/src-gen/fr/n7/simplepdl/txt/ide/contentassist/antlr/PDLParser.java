...
public class PDLParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, PDLGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getGuidanceAccess().getTextAssignment_2(), "rule__Guidance__TextAssignment_2");
			builder.put(grammarAccess.getRessourceAccess().getNameAssignment_1(), "rule__Ressource__NameAssignment_1");
			builder.put(grammarAccess.getRessourceAccess().getQuantityAssignment_2(), "rule__Ressource__QuantityAssignment_2");
			builder.put(grammarAccess.getUsefulRessourceAccess().getUsefulQuantityAssignment_1(), "rule__UsefulRessource__UsefulQuantityAssignment_1");
			builder.put(grammarAccess.getUsefulRessourceAccess().getRessourceAssignment_3(), "rule__UsefulRessource__RessourceAssignment_3");
		}
	}
