...
public class PDLFormatter extends AbstractFormatter2 {
  ...
  protected void _format(final WorkDefinition workDefinition, @Extension final IFormattableDocument document) {
    EList<UsefulRessource> _usefulRessources = workDefinition.getUsefulRessources();
    for (final UsefulRessource usefulRessource : _usefulRessources) {
      document.<UsefulRessource>format(usefulRessource);
    }
  }
