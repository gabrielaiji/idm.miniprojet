...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == SimplepdlPackage.eINSTANCE)
			...
			case SimplepdlPackage.USEFUL_RESSOURCE:
				sequence_UsefulRessource(context, (UsefulRessource) semanticObject); 
				return; 
	...
	protected void sequence_Ressource(ISerializationContext context, Ressource semanticObject) {
		...
		feeder.accept(grammarAccess.getRessourceAccess().getQuantityEIntParserRuleCall_2_0(), semanticObject.getQuantity());
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (usefulQuantity=EInt ressource=[Ressource|ID])
	 * </pre>
	 */
	protected void sequence_UsefulRessource(ISerializationContext context, UsefulRessource semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.USEFUL_RESSOURCE__USEFUL_QUANTITY) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.USEFUL_RESSOURCE__USEFUL_QUANTITY));
			if (transientValues.isValueTransient(semanticObject, SimplepdlPackage.Literals.USEFUL_RESSOURCE__RESSOURCE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, SimplepdlPackage.Literals.USEFUL_RESSOURCE__RESSOURCE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getUsefulRessourceAccess().getUsefulQuantityEIntParserRuleCall_1_0(), semanticObject.getUsefulQuantity());
		feeder.accept(grammarAccess.getUsefulRessourceAccess().getRessourceRessourceIDTerminalRuleCall_3_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.USEFUL_RESSOURCE__RESSOURCE, false));
		feeder.finish();
	}
