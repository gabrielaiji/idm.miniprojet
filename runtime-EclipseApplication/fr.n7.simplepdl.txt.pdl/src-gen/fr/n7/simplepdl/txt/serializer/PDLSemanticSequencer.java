...
public class PDLSemanticSequencer extends AbstractDelegatingSemanticSequencer {
	 ...
	 *
	 * Constraint:
	 *     (usefulQuantity=EInt ressource=[Ressource|EString])
	 * </pre>
	 */
	protected void sequence_UsefulRessource(ISerializationContext context, UsefulRessource semanticObject) {
		...
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getUsefulRessourceAccess().getUsefulQuantityEIntParserRuleCall_3_0(), semanticObject.getUsefulQuantity());
		feeder.accept(grammarAccess.getUsefulRessourceAccess().getRessourceRessourceEStringParserRuleCall_5_0_1(), semanticObject.eGet(SimplepdlPackage.Literals.USEFUL_RESSOURCE__RESSOURCE, false));
		feeder.finish();
	}
