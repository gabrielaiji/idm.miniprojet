...
public class InternalPDLParser extends AbstractInternalAntlrParser {
    public static final String[] tokenNames = new String[] {
        "<invalid>", "<EOR>", "<DOWN>", "<UP>", "RULE_STRING", "RULE_ID", "RULE_INT", "RULE_ML_COMMENT", "RULE_SL_COMMENT", "RULE_WS", "RULE_ANY_OTHER", "'process'", "'{'", "'}'", "'ProcessElement'", "'wd'", "'ws'", "'from'", "'to'", "'note'", "'Ressource'", "'quantity'", "'-'", "'s2s'", "'f2s'", "'s2f'", "'f2f'"
    };
    ...
    // InternalPDL.g:324:1: ruleWorkSequence returns [EObject current=null] : (otherlv_0= 'ws' ( (lv_linkType_1_0= ruleWorkSequenceType ) ) otherlv_2= 'from' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'to' ( (otherlv_5= RULE_ID ) ) ) ;
    public final EObject ruleWorkSequence() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:330:2: ( (otherlv_0= 'ws' ( (lv_linkType_1_0= ruleWorkSequenceType ) ) otherlv_2= 'from' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'to' ( (otherlv_5= RULE_ID ) ) ) )
            // InternalPDL.g:331:2: (otherlv_0= 'ws' ( (lv_linkType_1_0= ruleWorkSequenceType ) ) otherlv_2= 'from' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'to' ( (otherlv_5= RULE_ID ) ) )
            {
            // InternalPDL.g:331:2: (otherlv_0= 'ws' ( (lv_linkType_1_0= ruleWorkSequenceType ) ) otherlv_2= 'from' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'to' ( (otherlv_5= RULE_ID ) ) )
            // InternalPDL.g:332:3: otherlv_0= 'ws' ( (lv_linkType_1_0= ruleWorkSequenceType ) ) otherlv_2= 'from' ( (otherlv_3= RULE_ID ) ) otherlv_4= 'to' ( (otherlv_5= RULE_ID ) )
            {
            ...
            // InternalPDL.g:359:3: ( (otherlv_3= RULE_ID ) )
            // InternalPDL.g:360:4: (otherlv_3= RULE_ID )
            {
            // InternalPDL.g:360:4: (otherlv_3= RULE_ID )
            // InternalPDL.g:361:5: otherlv_3= RULE_ID
            {
            ...
            // InternalPDL.g:376:3: ( (otherlv_5= RULE_ID ) )
            // InternalPDL.g:377:4: (otherlv_5= RULE_ID )
            {
            // InternalPDL.g:377:4: (otherlv_5= RULE_ID )
            // InternalPDL.g:378:5: otherlv_5= RULE_ID
            {
    ...
    // InternalPDL.g:393:1: entryRuleGuidance returns [EObject current=null] : iv_ruleGuidance= ruleGuidance EOF ;
    public final EObject entryRuleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:393:49: (iv_ruleGuidance= ruleGuidance EOF )
            // InternalPDL.g:394:2: iv_ruleGuidance= ruleGuidance EOF
            {
    ...
    // InternalPDL.g:400:1: ruleGuidance returns [EObject current=null] : ( () otherlv_1= 'note' ( (lv_text_2_0= RULE_STRING ) ) ) ;
    public final EObject ruleGuidance() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:406:2: ( ( () otherlv_1= 'note' ( (lv_text_2_0= RULE_STRING ) ) ) )
            // InternalPDL.g:407:2: ( () otherlv_1= 'note' ( (lv_text_2_0= RULE_STRING ) ) )
            {
            // InternalPDL.g:407:2: ( () otherlv_1= 'note' ( (lv_text_2_0= RULE_STRING ) ) )
            // InternalPDL.g:408:3: () otherlv_1= 'note' ( (lv_text_2_0= RULE_STRING ) )
            {
            // InternalPDL.g:408:3: ()
            // InternalPDL.g:409:4: 
            {
            ...
            // InternalPDL.g:419:3: ( (lv_text_2_0= RULE_STRING ) )
            // InternalPDL.g:420:4: (lv_text_2_0= RULE_STRING )
            {
            // InternalPDL.g:420:4: (lv_text_2_0= RULE_STRING )
            // InternalPDL.g:421:5: lv_text_2_0= RULE_STRING
            {
    ...
    // InternalPDL.g:448:1: ruleRessource returns [EObject current=null] : (otherlv_0= 'Ressource' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'quantity' ( (lv_quantity_4_0= ruleEInt ) ) otherlv_5= '}' ) ;
    public final EObject ruleRessource() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:454:2: ( (otherlv_0= 'Ressource' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'quantity' ( (lv_quantity_4_0= ruleEInt ) ) otherlv_5= '}' ) )
            // InternalPDL.g:455:2: (otherlv_0= 'Ressource' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'quantity' ( (lv_quantity_4_0= ruleEInt ) ) otherlv_5= '}' )
            {
            // InternalPDL.g:455:2: (otherlv_0= 'Ressource' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'quantity' ( (lv_quantity_4_0= ruleEInt ) ) otherlv_5= '}' )
            // InternalPDL.g:456:3: otherlv_0= 'Ressource' ( (lv_name_1_0= ruleEString ) ) otherlv_2= '{' otherlv_3= 'quantity' ( (lv_quantity_4_0= ruleEInt ) ) otherlv_5= '}'
            {
            otherlv_0=(Token)match(input,20,FOLLOW_3); 

            			newLeafNode(otherlv_0, grammarAccess.getRessourceAccess().getRessourceKeyword_0());
            		
            // InternalPDL.g:460:3: ( (lv_name_1_0= ruleEString ) )
            // InternalPDL.g:461:4: (lv_name_1_0= ruleEString )
            {
            // InternalPDL.g:461:4: (lv_name_1_0= ruleEString )
            // InternalPDL.g:462:5: lv_name_1_0= ruleEString
            {
            ...
            // InternalPDL.g:487:3: ( (lv_quantity_4_0= ruleEInt ) )
            // InternalPDL.g:488:4: (lv_quantity_4_0= ruleEInt )
            {
            // InternalPDL.g:488:4: (lv_quantity_4_0= ruleEInt )
            // InternalPDL.g:489:5: lv_quantity_4_0= ruleEInt
            {
    ...
    // InternalPDL.g:514:1: entryRuleEInt returns [String current=null] : iv_ruleEInt= ruleEInt EOF ;
    public final String entryRuleEInt() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:514:44: (iv_ruleEInt= ruleEInt EOF )
            // InternalPDL.g:515:2: iv_ruleEInt= ruleEInt EOF
            {
    ...
    // InternalPDL.g:521:1: ruleEInt returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] : ( (kw= '-' )? this_INT_1= RULE_INT ) ;
    public final AntlrDatatypeRuleToken ruleEInt() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:527:2: ( ( (kw= '-' )? this_INT_1= RULE_INT ) )
            // InternalPDL.g:528:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            {
            // InternalPDL.g:528:2: ( (kw= '-' )? this_INT_1= RULE_INT )
            // InternalPDL.g:529:3: (kw= '-' )? this_INT_1= RULE_INT
            {
            // InternalPDL.g:529:3: (kw= '-' )?
            int alt4=2;
    ...
    // InternalPDL.g:547:1: ruleWorkSequenceType returns [Enumerator current=null] : ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) ;
    public final Enumerator ruleWorkSequenceType() throws RecognitionException {
        ...
        try {
            // InternalPDL.g:553:2: ( ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) ) )
            // InternalPDL.g:554:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            {
            // InternalPDL.g:554:2: ( (enumLiteral_0= 's2s' ) | (enumLiteral_1= 'f2s' ) | (enumLiteral_2= 's2f' ) | (enumLiteral_3= 'f2f' ) )
            int alt5=4;
            switch ( input.LA(1) ) {
            ...
            switch (alt5) {
                case 1 :
                    // InternalPDL.g:555:3: (enumLiteral_0= 's2s' )
                    {
                    // InternalPDL.g:555:3: (enumLiteral_0= 's2s' )
                    // InternalPDL.g:556:4: enumLiteral_0= 's2s'
                    {
                    ...
                    break;
                case 2 :
                    // InternalPDL.g:563:3: (enumLiteral_1= 'f2s' )
                    {
                    // InternalPDL.g:563:3: (enumLiteral_1= 'f2s' )
                    // InternalPDL.g:564:4: enumLiteral_1= 'f2s'
                    {
                    ...
                    break;
                case 3 :
                    // InternalPDL.g:571:3: (enumLiteral_2= 's2f' )
                    {
                    // InternalPDL.g:571:3: (enumLiteral_2= 's2f' )
                    // InternalPDL.g:572:4: enumLiteral_2= 's2f'
                    {
                    ...
                    break;
                case 4 :
                    // InternalPDL.g:579:3: (enumLiteral_3= 'f2f' )
                    {
                    // InternalPDL.g:579:3: (enumLiteral_3= 'f2f' )
                    // InternalPDL.g:580:4: enumLiteral_3= 'f2f'
                    {
